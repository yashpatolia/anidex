-- CreateEnum
CREATE TYPE "WatchStatus" AS ENUM ('WATCHING', 'COMPLETED', 'PLANNED', 'DROPPED', 'PAUSED', 'REWATCHING');
...
-- CreateIndex
CREATE UNIQUE INDEX "AnimeListEntry_userId_anilistId_key" ON "AnimeListEntry"("userId", "anilistId");
